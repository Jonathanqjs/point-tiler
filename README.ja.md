...
点群データ（LAS/LAZ/CSV/PLY）を 3D Tiles v1.1 に変換するツールです。
...
- **LAZ & PLY 対応** — 圧縮された LAZ ファイルの並列デコードや、ASCII / Binary 形式の PLY 点群データの読み込みに対応しています。
...
- LAS/LAZ/CSV/PLY 点群データを 3D Tiles v1.1 形式に変換
...
├── pcd-parser/                # LAS/LAZ/CSV/PLY ファイルパーサー
...
| オプション             | 説明                                                                                                                          |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `--input`, `-i`        | 入力ファイルパス。`.las`、`.laz`、`.csv`、`.txt`、`.ply` に対応。複数ファイル指定可能。                                      |
